...
# This cog defines moderation commands such as warn, purge, kick, ban, mute, and unmute. The mute and unmute commands also handle the creation of a Muted role if it doesn't exist. The setup function loads the cog when the bot starts.