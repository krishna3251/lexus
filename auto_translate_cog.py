...
from config import DISCORD_TOKEN  # Ensure your bot token is in config.py
...
# Load Cogs Dynamically (Including Translation Cog)
async def load_extensions():
    ...
    # Load Auto-Translate Cog Separately
    try:
        await bot.load_extension("auto_translate_cog")
        print("✅ Auto-Translate Cog Loaded")
    except Exception as e:
        print(f"❌ Failed to load Auto-Translate Cog: {e}")
